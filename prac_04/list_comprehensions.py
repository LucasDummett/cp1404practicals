...
big_numbers = [number for number in numbers if number > 9]  # ASK LINDSAY IF THIS WOULD HAVE BEEN SUITABLE "number_greater_than_9"
print(big_numbers)
...
large_names = ", ".join((name.split()[1] for name in full_names if len(name) > 11))
print(large_names)
